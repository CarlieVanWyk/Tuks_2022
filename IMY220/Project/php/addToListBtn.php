<?php
    ...
    <button id='addToListBTNid' type='button' class='btn' data-toggle='modal' 
            data-target='#addToListBtn" . $testEvent_id . "' data-whatever='@mdo'>
            <i class='fa-solid fa-circle-plus'></i><i class='fa-solid fa-bars-staggered'></i>
    </button>
    <div class='modal fade' id='addToListBtn" . $testEvent_id . "' tabindex='-1' role='dialog' 
        ...
        <div class='modal-dialog modal-dialog-centered' role='document'>
            <div class='modal-content'>
                ...
                // echo "Heloo: " . $row["localEvent_id"];
                // echo "Heloo: " . $testEvent_id;
                    ...
                    echo "
                        <div class='card' id='listCard'>
                            ...
                            <form action='submitEventToList.php' method='post'>
                                ...
                                <input type='hidden' name='localEvent_id' value='" . $testEvent_id . "'>
